...
public class SimplePicture implements DigitalPicture {
   ...
   * to be subclassed. By default all subclasses will implicitly call this in their parent's no
   * argument constructor unless a different call to super() is explicitly made as the first line of
  ...
  public SimplePicture(SimplePicture copyPicture) {
    ...
    if (copyPicture.bufferedImage != null) {
      this.bufferedImage =
          new BufferedImage(
              copyPicture.getWidth(), copyPicture.getHeight(), BufferedImage.TYPE_INT_RGB);
